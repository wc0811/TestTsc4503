...
//        realPrint(pStrMsg, strPringtIp, iPringtPoint);
    ...
    public static void printOutBoxZsc4503(List<String> pList) {
        ...
        for (String tItem : pList) {
            ...
            itemBean.setStrQRPosX("180");
            itemBean.setStrQRPosY("330");
    ...
    private static List<TscPrinterStrListBean> getListStrMsg() {
        ...
        tItem.setStrMsgPosX("355");
        tItem.setStrMsgPosY("130");
        tItem.setStrMsgX("40");
        tItem.setStrMsgY("40");
        listTemp.add(tItem);
        tItem = new TscPrinterStrListBean();
...
//        listTemp.add(tItem);
        ...
        tItem.setStrMsgPosX("355");
        tItem.setStrMsgPosY("305");
        tItem.setStrMsgX("45");
        tItem.setStrMsgY("45");
        listTemp.add(tItem);
        tItem = new TscPrinterStrListBean();
        tItem.setStrMsg(String.format("%s%s", "数量", "单位"));
        tItem.setStrMsgPosX("565");
        tItem.setStrMsgPosY("305");
        tItem.setStrMsgX("45");
        tItem.setStrMsgY("45");
        listTemp.add(tItem);
...
//        tItem.setStrMsg("2/300");
        tItem.setStrMsgPosX("205");
        tItem.setStrMsgPosY("345");
        tItem.setStrMsgX("45");
        tItem.setStrMsgY("45");
        listTemp.add(tItem);
        return listTemp;
